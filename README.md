...
- 当前调试 APK：`app/build/outputs/apk/debug/PaykiTodo-1.7.21-debug.apk`
...
- 规划台 AI 识别已完成设计落档，后续可接入 DeepSeek / Qwen / OpenAI-compatible Provider，但必须保持本地规则兜底、预览确认和不提交真实 API Key
...
这个仓库当前已经整理到一个**已构建的 `1.7.21` 开发基线**。
