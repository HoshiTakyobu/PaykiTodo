...
| 开源协议 | MIT License |
| 最新 Release | <https://github.com/HoshiTakyobu/PaykiTodo/releases/tag/v1.13.11> |
| APK 下载 | <https://github.com/HoshiTakyobu/PaykiTodo/releases/download/v1.13.11/PaykiTodo-1.13.11-release.apk> |
...
- 待办可选择全屏提醒或通知栏提醒。
- 提醒页区分“延后提醒”和“DDL 推迟”：延后只改下一次提醒，DDL 推迟才真正修改截止时间。
...
规划台是 PaykiTodo 的“上游规划区”，用于先写草稿，再把明确事项发布为正式待办或日程。

- 支持多篇规划文档。
- 手机端支持备忘录式 Outliner 输入、子任务、预览配置和新手教程。
- 支持 Markdown 兼容输入，能识别 `- [ ]`、子任务、自然 DDL、轻量日程、地点和提醒。
- 支持从分享、拍照、语音和图片识别入口快速捕获内容。
- 规划节点可以先作为草稿存在，用户确认后再发布为正式待办或日程。
- 已发布节点会和正式事项建立映射，可同步完成状态、刷新、顺延和处理冲突。
