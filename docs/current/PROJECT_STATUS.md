...
- Latest debug APK output:
  - `app/build/outputs/apk/debug/PaykiTodo-1.6.35-debug.apk`
...
The repository is now at `1.6.35` after simplifying todo batch import and sharing reminder-time parsing more broadly.

Most important current baseline facts:

- version metadata is `1.6.35 / 107`
...
Current docs have been synchronized for `1.6.35`:
