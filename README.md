...
- 当前调试 APK：`app/build/outputs/apk/debug/PaykiTodo-1.7.2-debug.apk`
...
- 手机端提供 Markdown 阅读渲染和全文编辑双模式；阅读模式会把 `- [ ]` / `- [x]` 显示为 checkbox，并把 `#tag` / `#imported` 显示为胶囊状态
