        ...
        setContent {
            ...
            TodoAlarmTheme(themeMode = uiState.settings.themeMode) {
                DashboardScreen(
                    ...
                    onSelectPlanningNote = viewModel::selectPlanningNote,
                    onCreatePlanningNote = viewModel::createPlanningNote,
                    onSavePlanningNote = viewModel::savePlanningNoteContent,
                    ...
                    observePlanningNodes = viewModel::observePlanningNodes,
                    ...
                    onGetPlanningMappings = viewModel::getPlanningMappings,
                    onRefreshPlanningImportedItems = viewModel::refreshPlanningImportedItems,
                    onPostponePlanningImportedItems = viewModel::postponePlanningImportedItems,
                    onUndoLastPlanningOperation = viewModel::undoLastPlanningOperation,
                    onApplyPlanningConflictDocument = viewModel::applyPlanningConflictDocument,
                    onApplyPlanningConflictItem = viewModel::applyPlanningConflictItem,
