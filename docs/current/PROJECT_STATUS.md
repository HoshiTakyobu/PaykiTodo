...
- Latest debug APK built locally:
  - `app/build/outputs/apk/debug/PaykiTodo-1.11.1-debug.apk`
- Verification completed for the `1.11.1 / versionCode 223` debug build:
