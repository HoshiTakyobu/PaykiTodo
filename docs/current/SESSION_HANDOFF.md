...
- The project is currently at code version `1.6.57` / `versionCode 129`
- Latest debug APK path after build should be `app/build/outputs/apk/debug/PaykiTodo-1.6.57-debug.apk`
...
1. Install `PaykiTodo-1.6.57-debug.apk`
2. Enable desktop sync and connect from a desktop browser
3. Hard-refresh the desktop page and verify it loads `/app.js?v=1.6.57`
...
- Broader UI-copy/comment cleanup beyond the concrete strings changed in 1.6.57
