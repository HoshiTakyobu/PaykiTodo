...
- The project is currently at code version `1.6.70` / `versionCode 142`.
- Latest debug APK path after build: `app/build/outputs/apk/debug/PaykiTodo-1.6.70-debug.apk`.
...
1. Install `PaykiTodo-1.6.70-debug.apk`.
