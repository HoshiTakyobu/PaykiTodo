...
- 当前调试 APK：`app/build/outputs/apk/debug/PaykiTodo-1.7.3-debug.apk`
...
- 手机端提供 Markdown 阅读渲染和全文编辑双模式；为避免历史文档阻断启动，进入规划台时默认先显示 `编辑全文`，用户主动点击 `预览` 后再渲染 Markdown
- 编辑模式提供 Markdown 文本编辑器和快捷输入栏，支持任务、子任务、缩进、DDL、日程、提醒、分组、今天、明天等快捷输入
