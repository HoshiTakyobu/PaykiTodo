...
- 当前调试 APK：`app/build/outputs/apk/debug/PaykiTodo-1.7.5-debug.apk`
...
- 手机端提供稳定的 Markdown 原文编辑器和快捷输入栏，支持任务、子任务、缩进、DDL、日程、提醒、分组、今天、明天等快捷输入
