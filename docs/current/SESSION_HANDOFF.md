...
- The project is currently at code version `1.6.71` / `versionCode 143`.
- Latest debug APK path after build: `app/build/outputs/apk/debug/PaykiTodo-1.6.71-debug.apk`.
...
1. Install `PaykiTodo-1.6.71-debug.apk`.
