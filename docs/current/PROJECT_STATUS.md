...
- Latest debug APK output:
  - `app/build/outputs/apk/debug/PaykiTodo-1.7.18-debug.apk`
...
- Planning Desk phone UI now uses solid-color editor/document surfaces, a fixed-height operation toolbar, a horizontal shortcut toolbar, a scrollable document picker, and a tighter recognition preview sheet.
- Planning Desk has an in-screen help sheet with workflow instructions and examples for todos, subtasks, DDL, reminders, groups, and schedule ranges.
...
Current docs have been synchronized for `1.7.18`:
...
1. Device-side verification is required to confirm `1.7.18` opens and the Calendar batch default-today parsing / Planning Desk toolbar feedback / parser edge cases / empty-document / placeholder / shortcut / delete / help-copy / auto-save / import persistence changes behave correctly.
