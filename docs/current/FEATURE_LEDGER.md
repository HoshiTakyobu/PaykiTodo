...
- phone editor mode remains a plain Markdown / natural-text editor with a solid-color document surface and horizontal shortcut toolbar for tasks, subtasks, indent/outdent, DDL, schedule, reminder, group, today, and tomorrow`r`n- phone Planning Desk includes an in-screen help sheet explaining the workflow and showing directly usable examples
