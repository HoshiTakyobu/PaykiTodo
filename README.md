...
- 当前调试 APK：`app/build/outputs/apk/debug/PaykiTodo-1.7.20-debug.apk`
...
- 手机端提供纯色文档式 Markdown 原文编辑器、可选 Markdown 预览、横向快捷输入栏和界面内说明页；新文档默认为空，示例只作为灰色 placeholder 呈现
...
这个仓库当前已经整理到一个**已构建的 `1.7.20` 开发基线**。
