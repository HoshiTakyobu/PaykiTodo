...
- 当前调试 APK：`app/build/outputs/apk/debug/PaykiTodo-1.7.1-debug.apk`
...
- 手机端提供 Markdown 文本编辑器和快捷输入栏，支持任务、子任务、缩进、DDL、日程、提醒、分组、今天、明天等快捷输入
