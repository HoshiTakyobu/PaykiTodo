...
- 当前调试 APK：`app/build/outputs/apk/debug/PaykiTodo-1.6.47-debug.apk`
...
这个仓库当前已经整理到一个**已提交的 `1.6.47` 开发基线**。
...
- 提醒声音策略已扩展为“播放通道 + PaykiTodo 内部音量 + 可选临时系统通道提升 + 课堂/上班模式”，并在设置页重整为常用 / 高级分区
