...
- `docs/current/START_NEW_SESSION.txt`
...
If it does not do this, stop it and tell it to follow `docs/current/START_NEW_SESSION.txt` exactly.
...
8. `README.md`
9. `docs/current/PROJECT_BACKLOG.md`
10. `CHANGELOG.md`
11. `git status`
...
7. if user-facing behavior, version references, or milestone docs became stale, update files such as `README.md`, `docs/current/PROJECT_BACKLOG.md`, `CHANGELOG.md`, or any relevant task-specific docs
...
6. update README.md / docs/current/PROJECT_BACKLOG.md / CHANGELOG.md or any other affected docs if your work changed what they claim
...
2. send `docs/current/START_NEW_SESSION.txt` again
